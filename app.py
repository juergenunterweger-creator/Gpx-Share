...
DEFAULTS = {
    ...
    "margin_top": 150,
    "margin_bottom": 100,
    "img_zoom": 100,          # NEU: Bild Zoom in Prozent (Standard 100%)
    "img_offset_x": 0,        
    "img_offset_y": 0         
}
...
# --- OPTIONEN ---
with st.expander("⚙️ Einstellungen [v2.9.2 Beta]", expanded=False): 
    ...
    # HIER: Zoom in Prozent (10% bis 500%)
...
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    ...
    st.info("**v2.9.2 Beta:**\n- Zoom-Werte für intuitivere Bedienung auf Prozent umgestellt (10% - 500%).\n- Stabile v2.8.1 Basis ohne DB.")
    st.markdown("---")
...
if up_gpx:
    try:
        ...
        if up_img:
            ...
            bg_w, bg_h = bg.size
            # Zoom-Prozentwert umrechnen (z.B. 100 / 100.0 = 1.0)
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v292_beta.png", "image/png")
