...
# --- STANDARDWERTE (v4.2.0 / Basis v2.8.1) ---
DEFAULTS = {
...
# --- OPTIONEN ---
with st.expander("⚙️ Einstellungen [v4.2.0]", expanded=False): 
...
# --- APP INSTALLIEREN (SAFARI, CHROME, FIREFOX) ---
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v420.png", "image/png")
