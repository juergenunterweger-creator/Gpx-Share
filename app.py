...
# --- AGGRESSIVER BRANDING KILLER (v2.8.1) ---
hide_st_style = """
            <style>
...
# --- ADMIN & COUNTER LOGIK ---
# Check: Bist du es? (URL-Parameter ?admin=true)
...
def trigger_counter():
    ...
    if HAS_GSHEETS and not is_admin:
        try:
            ...
            pass # App läuft bei Fehlern im Tracking einfach weiter
...
# --- OPTIONEN ---
with st.expander("⚙️ Einstellungen [v2.8.1]", expanded=False): 
...
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    ...
    st.info("**v2.8.1 (Aktuell):**\n- Rollback auf sauberes Branding.\n- Google Sheets Counter integriert.\n- Admin-Check aktiv (Zählt dich nicht mit).")
    st.markdown("---")
...
if up_gpx:
    try:
        ...
        if st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v281.png", "image/png"):
            trigger_counter()
