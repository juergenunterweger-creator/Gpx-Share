...
with c_up1:
    ...
    # KOMPLETTER FILTER ENTFERNT FÜR iOS!
    up_gpx = st.file_uploader("GPX Upload", type=None, label_visibility="collapsed", key="gpx_uploader")
    if up_gpx:
...
# --- EINSTELLUNGEN ---
with st.expander("⚙️ Einstellungen [v3.1.10 Beta]", expanded=False): 
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), "tour_v3110_beta.png", "image/png")
