...
# --- APP KONFIGURATION ---
# Sucht nach deinem Logo für den Browser-Tab (Favicon)
def get_fav_icon():
...
# --- OPTIONEN ---
with st.expander("⚙️ Einstellungen [v4.1.0]", expanded=False): 
...
# --- APP INSTALLIEREN REITER (ERWEITERT UM FIREFOX) ---
...
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    ...
    st.markdown("### 📜 Changelog v4.1.0")
    st.info("- Favicon (logo_icon.png) integriert.\n- Firefox Installations-Anleitung hinzugefügt.\n- Name auf v4.1.0 geändert.")
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v410.jpg", "image/jpeg")
