...
# --- EINSTELLUNGEN ---
with st.expander("⚙️ Einstellungen [v3.0.7 Beta]", expanded=False): 
...
with st.expander("ℹ️ Über & Impressum", expanded=False):
    st.info("**v3.0.7 Beta:** Raster im Profil repariert & Minibox-Position stabilisiert.")
    st.markdown("""
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), "tour_final.png", "image/png")
