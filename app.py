...
# --- NEUE EINSTELLUNGEN (VERSION 3.1.0 Beta) ---
...
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    ...
    st.info("**v3.1.0 Beta:**\n- **NEU:** Das 'Modern (White Card)'-Layout wurde hinzugefügt! Ein komplett alternatives Design für eine helle, cleane Datenansicht.")
    st.markdown("---")
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v310_beta.png", "image/png")
