...
with st.sidebar:
    ...
    menu = st.radio("Menü", ["📸 GPX Generator", "ℹ️ Über GPX Share"])

# ==========================================
# MENÜPUNKT 1: DER GENERATOR
# ==========================================
if menu == "📸 GPX Generator":
...
# ==========================================
# MENÜPUNKT 2: ÜBER GPX SHARE
# ==========================================
elif menu == "ℹ️ Über GPX Share":
    st.markdown("<p class='title-modern'>Über GPX Share</p>", unsafe_allow_html=True)
    ...
    * **⚙️ Voll anpassbar:** Routenfarbe, Linienstärke, Transparenz und sogar ein eigenes Logo mit Apple-Like abgerundeten Ecken – alles ist mit einem Klick anpassbar.
