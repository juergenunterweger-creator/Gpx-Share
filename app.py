...
with st.sidebar:
    ...
    b_alpha = st.slider("Balken Deckkraft", 0, 255, 170)
...
if up_img and up_gpx:
    try:
        ...
        if pts:
            ...
            # --- GETEILTE INFO BALKEN (Oben & Unten) ---
            bh_top = int(h * 0.10)
            bh_bot = int(h * 0.12)
            ...
            # --- TEXTE SCHREIBEN (MIT NEUER ANCHOR-METHODE) ---
            # mm = middle/middle (zentriert den Text perfekt im Balken)
