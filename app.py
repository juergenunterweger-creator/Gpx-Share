...
c1, c2 = st.columns(2)
with c1:
    up_img = st.file_uploader("📸 Foto wählen", type=["jpg", "jpeg", "png"])
with c2:
    up_gpx = st.file_uploader("📍 GPX Datei")
...
with st.sidebar:
    ...
    f_size_title = st.slider("Schriftgröße Titel", 50, 600, 250) 
    f_size_data = st.slider("Schriftgröße Daten", 50, 400, 160)
