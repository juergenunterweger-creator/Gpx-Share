...
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    ...
    # --- NEU: APP TEILEN SEKTION ---
    st.markdown("**App teilen:**")
    # Hier setzen wir die URL deiner App ein (Platzhalter, Streamlit erkennt sie oft selbst)
    app_url = "https://gpx-share-pro.streamlit.app" # <- Hier ggf. deine echte URL anpassen
    
    col_qr, col_link = st.columns([1, 2])
    with col_qr:
        # Erzeugt einen QR-Code über eine API
