...
# Padding und Margins wurden reduziert, um den Header flacher zu machen
st.markdown("""
            <style>
...
# --- HELFER FUNKTIONEN (Stabilisiert) ---
...
# --- OPTIONEN ---
with st.expander("⚙️ Einstellungen [v3.2.1]", expanded=False): 
    ...
    with col_opt1:
        ...
        st.number_input("1b. Routenstärke", 1, 20, key="w_line")
    with col_opt2:
        st.checkbox("4. Start/Ziel", key="show_markers")
...
# --- NEU: APP INSTALLIEREN (ZURÜCK & ERWEITERT) ---
with st.expander("📲 App installieren (Safari, Chrome, Firefox)", expanded=False):
    ...
    with c3:
        st.markdown("**🦊 Firefox**\n1. Drei Punkte ⋮\n2. 'Installieren' oder 'Zum Startbildschirm'")

# --- INFO REITER ---
with st.expander("ℹ️ Über GPX Share Pro", expanded=False):
    st.markdown("### 📜 v3.2.1 Changelog")
    st.info("- Header-Höhe reduziert.\n- logo.png im Header integriert.\n- Installation-Reiter (incl. Firefox) hinzugefügt.")
    st.markdown(f'<a href="https://www.paypal.com/donate?hosted_button_id=FF6FBUE84V7MG" target="_blank"><img src="https://www.paypalobjects.com/de_DE/i/btn/btn_donateCC_LG.gif" width="120"></a>', unsafe_allow_html=True)
    st.markdown(f'<a href="whatsapp://send?text=Check%20das%20aus:%20www.gpx-share.at" style="display: block; width: 100%; padding: 10px; background-color: #25D366; color: white; text-align: center; text-decoration: none; border-radius: 5px; font-weight: bold;">🚀 App empfehlen</a>', unsafe_allow_html=True)
...
if up_gpx:
    try:
        ...
        st.download_button("🚀 BILD SPEICHERN", buf.getvalue(), f"tour_v321.jpg", "image/jpeg")
